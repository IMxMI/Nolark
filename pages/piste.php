...
<body>
    ...
    <section id="casques">
        ...
        <article>
            <img src="../images/casques/piste/shoei-x-spirit-ii-marquez-2-tc1.jpg"
                alt="shoei x spirit ii marquez 2 tc1">
            <p class="stockok"><abbr data-tip="Plus que 2 casques en stock...">stock</abbr></p>
        ...
        <article>
            <img src="../images/casques/piste/shoei-xr-1100-transmission-tc10.jpg"
                alt="shoei xr 1100 transmission tc10">
            <p class="stockko"><abbr data-tip="Sur commande uniquement">stock</abbr></p>
