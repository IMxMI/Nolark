...
<body>
    ...
    <section id="video">
        ...
        <iframe frameborder="0" width="480" height="270" src="http://www.dailymotion.com/embed/video/xdl390">
        </iframe>
    </section>
    <section id="casques">
        <!-- - - - - - - - - - - - - - LIGNE N°1 - - - - - - - - - - - - -->
        ...
        <article>
            <img src="../images/casques/enfants/nexx-x60-cool-kids-blanc-brillant.jpg"
        ...
        <!-- - - - - - - - - - - - - - LIGNE N°7 - - - - - - - - - - - - -->
        <article>
            <img src="../images/casques/enfants/nexx-x60-kid-vision-neon-jaune.jpg"
                alt="nexx x60 kid vision neon jaune">
            <p class="stockok"><abbr data-tip="13 casques en stock">stock</abbr></p>
        ...
        <article>
            <img src="../images/casques/enfants/nexx-x60-kid-vision-neon-orange.jpg"
                alt="nexx x60 kid vision neon orange">
            <p class="stockok"><abbr data-tip="Plus que 6 casques en stock...">stock</abbr></p>
        ...
        <article>
            <img src="../images/casques/enfants/nexx-x60-kids-vintage-noir-noir.jpg"
                alt="nexx x60 kids vintage noir noir">
            <p class="stockok"><abbr data-tip="12 casques en stock">stock</abbr></p>
